...
CREATE TABLE `categories` (
  ...
  `meta_title` char(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `description` varchar(400) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `product_images` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `file` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `alt` char(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `product_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `first_name` char(50) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `last_name` char(60) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `email` char(50) COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- Dump completed on 2021-05-23 12:38:13
